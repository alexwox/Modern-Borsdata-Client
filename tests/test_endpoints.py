...
def test_get_countries(mock_client):
    ...
    # Create mock response
    create_mock_response('countries', {
        "countries": [
...
def test_get_markets(mock_client):
    ...
    # Create mock response
    create_mock_response('markets', {
        "markets": [
            {"id": 1, "name": "Test Market 1", "countryId": 10, "isIndex": False, "exchangeName": "Exchange 1"},
            {"id": 2, "name": "Test Market 2", "countryId": 20, "isIndex": True, "exchangeName": "Exchange 2"}
        ]
    })
...
def test_get_instruments(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments', {
        "instruments": [
            {
                "insId": 1, 
...
def test_get_global_instruments(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/global', {
        "instruments": [
            {
                "insId": 1001, 
...
def test_get_stock_prices(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/1/stockprices', {
        "instrument": 1,
        "stockPricesList": [
            {
                "d": "2023-01-01",
...
def test_get_reports(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/1/reports/year', {
        "instrument": 1,
        "reports": [
            {
                "year": 2022,
                ...
                "profit_Before_Tax": 250000,
                "profit_To_Equity_Holders": 200000,
                "earnings_Per_Share": 2.5,
                "number_Of_Shares": 80000,
                "dividend": 1.0,
                "intangible_Assets": 100000,
                "tangible_Assets": 200000,
    ...
    assert reports[0].revenues == 1000000
    assert reports[0].earnings_per_share == 2.5
        ...
        "list": [
            {
                ...
                "values": [
                    {
                        "releaseDate": "2023-04-01T08:00:00",
                        "reportType": "Q1"
                    }
                ],
                "error": None
...
def test_get_kpi_history(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/1/kpis/2/year/mean/history', {
        "kpiId": 2,
        "group": "Test Group",
...
def test_get_kpi_updated(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/kpis/updated', {
        "kpisCalcUpdated": "2023-01-15T12:30:45"
    })
...
def test_get_stock_splits(mock_client):
    ...
    # Create mock response
    create_mock_response('instruments/stocksplits', {
        "stockSplits": [
            {
                "insId": 1,
